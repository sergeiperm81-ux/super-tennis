...
async function getArticleLinks(): Promise<EntityLink[]> {
  ...
  const staticLinks: EntityLink[] = [
    ...
    // Masters & year-end
    { name: 'ATP Finals', url: '/tournaments/atp-finals-complete-guide/', pattern: /\bATP Finals\b/g },
    { name: 'WTA Finals', url: '/tournaments/wta-finals-guide/', pattern: /\bWTA Finals\b/g },
    { name: 'Indian Wells', url: '/tournaments/indian-wells-complete-guide/', pattern: /\bIndian Wells\b/g },
    { name: 'Miami Open', url: '/tournaments/miami-open-complete-guide/', pattern: /\bMiami Open\b/g },
    { name: 'Monte Carlo', url: '/tournaments/monte-carlo-masters-complete-guide/', pattern: /\bMonte[- ]Carlo\b/g },
    { name: 'Shanghai Masters', url: '/tournaments/shanghai-masters-complete-guide/', pattern: /\bShanghai (?:Masters|Open)\b/g },
    // Team events
    ...
    { name: 'tennis balls', url: '/gear/best-tennis-balls-comparison/', pattern: /\btennis balls?\b/gi },
    ...
    { name: 'fastest serve', url: '/records/fastest-tennis-serves-ever/', pattern: /\bfastest serve\b/gi },
