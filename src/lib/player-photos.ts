...
export const gearArticlePhotos: Record<string, ArticlePhoto> = {
  ...
  'tennis-elbow-arm-friendly-rackets': { type: 'local', value: '/images/gear/tennis-elbow.webp' },
  ...
  // Accessories & Apparel
  'tennis-accessories-essentials': { type: 'local', value: '/images/gear/tennis-net.webp' },
  ...
  // Courts & Elbow
  'tennis-court-equipment-setup': { type: 'local', value: '/images/records/tennis-court-aerial.webp' },
...
export const recordsArticlePhotos: Record<string, ArticlePhoto> = {
  ...
  'longest-match-tennis': { type: 'local', value: '/images/tournaments/wimbledon.webp' },
...
export const tournamentArticlePhotos: Record<string, ArticlePhoto> = {
  ...
  'indian-wells-guide': { type: 'local', value: '/images/tournaments/indian-wells.webp' },
  'miami-open-guide': { type: 'local', value: '/images/tournaments/miami.webp' },
  'atp-finals-guide': { type: 'local', value: '/images/tournaments/atp-finals.webp' },
  ...
  'monte-carlo-masters-guide': { type: 'local', value: '/images/tournaments/monte-carlo.webp' },
  'shanghai-masters-guide': { type: 'local', value: '/images/tournaments/shanghai.webp' },
