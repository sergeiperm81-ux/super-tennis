...
export const gearArticlePhotos: Record<string, ArticlePhoto> = {
  ...
  'best-tennis-rackets-women-2026': { type: 'local', value: '/images/gear/_new_athlete1.webp' },
  ...
  'tennis-racket-brands-ranked': { type: 'local', value: '/images/gear/_new_rackets1.webp' },
  ...
  'used-tennis-rackets-buying-guide': { type: 'local', value: '/images/gear/_test_equip15.webp' },
  // Shoes
  ...
  'best-tennis-shoes-flat-feet': { type: 'local', value: '/images/gear/_test_equip11.webp' },
  'best-tennis-court-shoes-2026': { type: 'local', value: '/images/gear/_test_equip10.webp' },
  ...
  'tennis-overgrip-guide': { type: 'local', value: '/images/gear/_new_rackets2.webp' },
  'tennis-overgrip-comparison': { type: 'local', value: '/images/gear/tennis-overgrip-compare.webp' },
  // Bags
  'tennis-bag-guide': { type: 'local', value: '/images/gear/_test_equip09.webp' },
  ...
  'best-tennis-rebounders-practice-walls': { type: 'local', value: '/images/gear/_test_equip12.webp' },
  // Gifts & Misc
  'best-tennis-gifts-2026': { type: 'local', value: '/images/lifestyle/tennis-fan-culture.webp' },
  'tennis-equipment-maintenance-guide': { type: 'local', value: '/images/gear/_test_equip13.webp' },
  // Courts & Elbow
  ...
  'tennis-equipment-buying-guide-for-club-players': { type: 'local', value: '/images/gear/_test_equip14.webp' },
...
export const lifestyleArticlePhotos: Record<string, ArticlePhoto> = {
  ...
  'tennis-player-cars-collection': { type: 'local', value: '/images/lifestyle/tennis-player-cars.webp' },
  ...
  'best-tennis-books-all-time': { type: 'local', value: '/images/lifestyle/tennis-books.webp' },
  'best-tennis-podcasts-2026': { type: 'local', value: '/images/lifestyle/tennis-podcasts.webp' },
  'best-tennis-instagram-accounts': { type: 'local', value: '/images/lifestyle/tennis-instagram.webp' },
  'tennis-in-movies-tv-shows': { type: 'local', value: 'https://images.unsplash.com/photo-1440404653325-ab127d49abc1?w=800&q=80' },
  'tennis-and-music-players-dj-sing': { type: 'local', value: '/images/lifestyle/tennis-music-dj.webp' },
  ...
  'tennis-player-tattoos-stories': { type: 'local', value: '/images/lifestyle/tennis-tattoos.webp' },
  // Health & Wellness
  ...
  'tennis-players-deal-with-pressure': { type: 'local', value: '/images/lifestyle/tennis-pressure.webp' },
  'tennis-injuries-common': { type: 'local', value: '/images/lifestyle/tennis-injuries.webp' },
  ...
  'tennis-brain-health-dementia': { type: 'local', value: '/images/lifestyle/tennis-brain-health.webp' },
  'tennis-osteoporosis-bone-health': { type: 'local', value: '/images/lifestyle/tennis-bone-health.webp' },
  'tennis-adds-10-years-life': { type: 'local', value: '/images/lifestyle/tennis-longevity.webp' },
  ...
  'tennis-player-workout-gym-routine': { type: 'local', value: '/images/lifestyle/tennis-training.webp' },
  'tennis-player-morning-routines': { type: 'local', value: '/images/lifestyle/tennis-morning-routine.webp' },
  ...
  'tennis-diet-nutrition': { type: 'local', value: '/images/lifestyle/tennis-nutrition.webp' },
  'tennis-diet-nutrition-guide': { type: 'local', value: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=800&q=80' },
  'tennis-player-diet-what-pros-eat': { type: 'local', value: '/images/lifestyle/tennis-player-diet.webp' },
  // Relationships & Social
  'tennis-couples-love-stories': { type: 'local', value: '/images/lifestyle/tennis-couples.webp' },
  'tennis-couples-relationship': { type: 'local', value: 'https://images.unsplash.com/photo-1516589178581-6cd7833ae3b2?w=800&q=80' },
  'tennis-wags-partners-biggest-stars': { type: 'local', value: '/images/lifestyle/tennis-wags.webp' },
  ...
  'tennis-social-media-player-brands': { type: 'local', value: '/images/lifestyle/tennis-social-media.webp' },
  ...
  'tennis-grandparents-grandkids': { type: 'local', value: '/images/lifestyle/tennis-grandparents.webp' },
  ...
  'tennis-age-not-barrier-late-starters': { type: 'local', value: '/images/lifestyle/tennis-after-50.webp' },
  // Travel & Experience
  ...
  'tennis-travel-best-cities-live-tennis': { type: 'local', value: '/images/lifestyle/tennis-travel-cities.webp' },
  ...
  'tennis-coaching-tips-beginners': { type: 'local', value: '/images/lifestyle/tennis-coaching.webp' },
  ...
  'how-to-become-professional-tennis-player': { type: 'local', value: '/images/lifestyle/tennis-become-pro.webp' },
  'tennis-etiquette-rules-fans': { type: 'local', value: '/images/lifestyle/tennis-etiquette.webp' },
  ...
  'best-tennis-academies-world': { type: 'local', value: '/images/lifestyle/tennis-academy.webp' },
  ...
  'tennis-vs-padel-differences': { type: 'local', value: '/images/lifestyle/tennis-vs-padel.webp' },
  ...
  'tennis-vs-golf-retirement-sport': { type: 'local', value: '/images/lifestyle/tennis-vs-golf.webp' },
  ...
  'tennis-player-nicknames-history': { type: 'local', value: '/images/lifestyle/tennis-nicknames.webp' },
  'tennis-player-heights-does-size-matter': { type: 'local', value: '/images/lifestyle/tennis-heights.webp' },
  'tennis-retirement-life-after-tour': { type: 'local', value: '/images/lifestyle/tennis-retirement-tour.webp' },
  ...
  'tennis-best-rivalries-all-time': { type: 'local', value: '/images/tournaments/wimbledon.webp' },
...
export const recordsArticlePhotos: Record<string, ArticlePhoto> = {
  ...
  'longest-winning-streaks-tennis': { type: 'player', value: 'martina-navratilova' },
  ...
  'most-aces-tennis-history-records': { type: 'player', value: 'reilly-opelka' },
  'tennis-prize-money-history': { type: 'local', value: '/images/records/tennis-court-aerial.webp' },
  'most-masters-1000-titles': { type: 'local', value: '/images/tournaments/indian-wells.webp' },
  'tennis-surface-records': { type: 'player', value: 'rafael-nadal' },
  'grand-slam-hat-tricks': { type: 'player', value: 'serena-williams' },
  'doubles-records-tennis': { type: 'local', value: '/images/tournaments/davis-cup.webp' },
  'tennis-goat-debate': { type: 'local', value: '/images/tournaments/melbourne-park.webp' },
  'best-tennis-matches-ever': { type: 'local', value: '/images/tournaments/atp-finals.webp' },
  'tennis-earnings-all-time': { type: 'local', value: '/images/tournaments/miami.webp' },
  'tennis-comebacks-greatest': { type: 'player', value: 'andy-murray' },
  'tennis-first-time-records': { type: 'player', value: 'jannik-sinner' },
  'tennis-streaks-records': { type: 'player', value: 'bjorn-borg' },
  'tennis-olympic-records': { type: 'local', value: '/images/tournaments/roland-garros.webp' },
  'tennis-tiebreak-records': { type: 'local', value: '/images/tournaments/shanghai.webp' },
};
