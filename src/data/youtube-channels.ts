...
const tennisTv: YouTubeChannel = {
  ...
  videos: [
    { id: 'u7Dn6GIoIu4', title: 'Alcaraz Didn\'t Lose A Point On Serve In The Deciding Set', channelName: 'Tennis TV', description: 'Carlos Alcaraz delivers a flawless serving performance in the deciding set to secure an impressive ATP win.' },
    ...
    { id: 'RYkGC4ojefM', title: 'Djokovic and Tsitsipas Team Up For Indian Wells Doubles', channelName: 'Tennis TV', description: 'Novak Djokovic and Stefanos Tsitsipas unite as a doubles pairing at Indian Wells 2026 in a fan-favourite match.' },
    { id: 'Ki-BF0votGs', title: 'Alcaraz Battles Rinderknech In Third Round | Indian Wells 2026', channelName: 'Tennis TV', description: 'Carlos Alcaraz fights hard to defeat Antoine Rinderknech in the third round at the 2026 Indian Wells Masters.' },
    ...
    { id: 's9XCjQtvbMI', title: 'Casper Ruud vs Vacherot Highlights | Indian Wells 2026', channelName: 'Tennis TV', description: 'Match highlights as Casper Ruud faces Mathias Bourgue-Vacherot in the 2026 Indian Wells third round.' },
    { id: 'AAo9zzOFG7k', title: 'Taylor Fritz vs Alex Michelsen Highlights | Indian Wells 2026', channelName: 'Tennis TV', description: 'American rivals Taylor Fritz and Alex Michelsen clash in an all-USA Indian Wells 2026 showdown.' },
    { id: 'qmz4rD9FbaU', title: 'Bublik vs Hijikata Match Highlights | Indian Wells 2026', channelName: 'Tennis TV', description: 'Alexander Bublik takes on Rinky Hijikata in an entertaining second-round match at the 2026 Indian Wells Masters.' },
    ...
    { id: 'hGFcGENjdEw', title: 'Draper vs Cerundolo Highlights | Indian Wells 2026', channelName: 'Tennis TV', description: 'Jack Draper battles Francisco Cerundolo in a hard-court contest at the 2026 Indian Wells Masters.' },
    { id: 'zOLNuW-D6og', title: 'Sinner & Opelka Battle in Tennis Paradise | Indian Wells 2026', channelName: 'Tennis TV', description: 'Jannik Sinner and Reilly Opelka square off in a power-packed match at Indian Wells 2026.' },
    { id: 'v2diCvtL3ug', title: 'Djokovic vs Kovacevic Round 3 | Indian Wells 2026 Highlights', channelName: 'Tennis TV', description: 'Novak Djokovic overcomes qualifier Aleksandar Kovacevic in the third round at Indian Wells 2026.' },
    { id: 'ZRuwkGdqUIU', title: 'De Minaur vs Norrie Highlights | Indian Wells 2026', channelName: 'Tennis TV', description: 'Alex De Minaur and Cameron Norrie face off in a competitive third-round match at the 2026 Indian Wells Open.' },
    { id: 'ukVb62Lzjpc', title: '2021 Champ Norrie Keeps Rolling in Tennis Paradise', channelName: 'Tennis TV', description: 'Former Indian Wells champion Cameron Norrie continues his 2026 run with a strong performance in Tennis Paradise.' },
...
const wta: YouTubeChannel = {
  ...
  videos: [
    ...
    { id: '06VCqNeOK3Y', title: 'Kostyuk vs Rybakina | Indian Wells 2026 R3 Highlights', channelName: 'WTA', description: 'Marta Kostyuk takes on Elena Rybakina in a third-round clash at the 2026 Indian Wells WTA tournament.' },
    { id: 'z8Sffkz5m8s', title: 'Madison Keys vs Kartal | Indian Wells 2026 R3 Highlights', channelName: 'WTA', description: 'Madison Keys battles Sonay Kartal in the third round of the 2026 BNP Paribas Open.' },
    ...
    { id: 'L6tmpB_k8sY', title: 'Krueger vs Svitolina | Indian Wells 2026 R3 Highlights', channelName: 'WTA', description: 'Ashlyn Krueger faces former top-10 player Elina Svitolina in the third round at Indian Wells 2026.' },
    { id: 'HjJU_asNptQ', title: 'Andreeva vs Siniakova | Indian Wells 2026 R3 Highlights', channelName: 'WTA', description: 'Mirra Andreeva and Katerina Siniakova contest a third-round match at the 2026 Indian Wells Open.' },
    { id: 'XrM38bRHIU0', title: 'Mertens vs Bencic | Indian Wells 2026 R3 Highlights', channelName: 'WTA', description: 'Elise Mertens takes on returning champion Belinda Bencic in the Indian Wells 2026 third round.' },
    { id: 'vqz2Ql13RXU', title: 'Pegula vs Ostapenko | Indian Wells 2026 R3 Highlights', channelName: 'WTA', description: 'Jessica Pegula and Jelena Ostapenko produce an aggressive third-round encounter at Indian Wells 2026.' },
    ...
    { id: 't1qaXXVUXds', title: 'Iga Swiatek Gets the Win Over Sakkari', channelName: 'WTA', description: 'Iga Swiatek outclasses Maria Sakkari with her characteristic precision and aggression at Indian Wells 2026.' },
    ...
    { id: '2UkEYcF1Aic', title: 'Big Win for Katerina Siniakova', channelName: 'WTA', description: 'Katerina Siniakova earns an important WTA singles victory with an impressive all-round performance.' },
