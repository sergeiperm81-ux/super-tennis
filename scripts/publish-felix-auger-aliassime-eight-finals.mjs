...
const slug = 'felix-auger-aliassime-lost-eight-finals-wimbledon-2026';
const now = new Date().toISOString();

const body = `There is a particular kind of torture reserved for the prodigy who is very nearly good enough. Felix Auger-Aliassime knows it better than almost anyone alive. For years, the most gifted young player in Canadian tennis history could do the near-impossible part — beat great players, win six matches in a row, march all the way to the final of a professional tournament — and then, once he got there, he would lose. Not once. Not twice. Eight times in a row. Eight finals reached, eight finals lost, a golden boy who could conquer everyone in the draw except the last man standing.
...
Start with the present, because it is a good place for him to be. Auger-Aliassime has worked his way into the quarter-finals at Wimbledon, back among the last eight at a Grand Slam, and his reward is the sternest examination in the sport: a meeting with Novak Djokovic, the seven-time champion [chasing yet more history on his favourite lawn](/lifestyle/novak-djokovic-wimbledon-2026-25th-slam-eighth-title-quest). It is exactly the kind of stage the young Felix was always supposed to reach — and, for a while, exactly the kind of stage where his career kept stalling.
...
The high point of the early years came in New York. At the 2021 US Open, Auger-Aliassime finally delivered the run his talent had always promised, reaching the semi-finals of a Grand Slam for the first time. On the way he beat a series of dangerous players, among them the charismatic American [Frances Tiafoe](/lifestyle/frances-tiafoe-grew-up-tennis-center-wimbledon-2026), before running into Daniil Medvedev — then the world number two and imperious that fortnight — and losing in straight sets in the last four.
...
const meta = {
  slug,
  title: 'Felix Auger-Aliassime Lost His First Eight Finals. Then He Learned How to Win.',
  excerpt: 'The anointed prodigy who could win six matches at a tournament and never the seventh, Felix Auger-Aliassime lost his first eight finals before he learned how to win.',
  body,
  category: 'lifestyle',
  status: 'published',
