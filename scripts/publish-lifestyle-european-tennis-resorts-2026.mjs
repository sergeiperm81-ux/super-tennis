...
const slug = 'best-european-tennis-resorts-2026-grand-slam-holiday';
const now = new Date().toISOString();

const body = `This article contains affiliate links. If you purchase through these links, we may earn a small commission at no extra cost to you.
...
If you came here looking for where to watch the best tennis live, our [Best Cities to Watch Live Tennis](/lifestyle/tennis-travel-best-cities-live-tennis/) guide is the companion piece. This one is for the guest who books seven nights and walks onto the court three times a day.
...
**Best for:** intermediate guests who want a tour-grade coaching brand without booking a tour-grade week.
**Surface:** hard courts.
...
**Best for:** clay-court diehards who want the most Nadal-faithful coaching outside Manacor itself.
**Surface:** red clay (seven courts).
**Standout off-court:** the trophy room and a beach that locals still rate higher than the Marbella Old Town's better-known stretches.
...
**Best for:** group trips, family holidays, multi-sport itineraries.
**Surface:** mixed (hard, clay, synthetic).
**Standout off-court:** scale. La Manga is a small village dressed as a resort, and the choice on any given day is unusually wide.
...
**Best for:** Italian-coast luxury combined with multi-week tennis programming.
**Surface:** hard with padel and pickleball.
...
**Best for:** couples and family trips that want tennis without committing to a single-sport itinerary.
**Surface:** mixed (GreenSet, synthetic grass, plus padel/pickleball).
**Standout off-court:** the view. Few European tennis settings have it.
...
**Best for:** intermediate club players who want a coaching program that has been refined across a long run.
**Surface:** clay and hard.
**Standout off-court:** the cliffs. The Algarve red rock is the visual identity of this resort.
...
**Best for:** the design-led traveller, the romantic week, the photographer's dream.
**Surface:** hard inside the Diamond Domes.
...
**Best for:** clay-court purists, training-camp loyalists, and anyone who wants the highest court count on the eastern Mediterranean.
**Surface:** red clay, with padel and pickleball.
**Standout off-court:** the Aegean. Several courts have a sea view of the kind Roland Garros itself does not have.
...
- **Mouratoglou** runs its own academy bookings out of Biot, Bodrum and Costa Navarino. The Mouratoglou ecosystem is integrated — you can book a week, get a player evaluation, and have your stroke video shared with a coach who has worked with [Serena Williams](/players/serena-williams/)' team.
...
const meta = {
  slug,
  title: "Europe's Best Tennis Resorts: Eight Places Where the Tennis Is As Good As the Spa",
  excerpt: "European luxury hospitality has quietly absorbed tennis. From Patrick Mouratoglou's Aegean outpost in Bodrum to a Rafa Nadal academy on the Costa del Sol, from Diamond Domes above Lake Lucerne to 26 clay courts on a Cretan beach — the eight resorts where you can build a serious tennis holiday around the courts, not just play a few sets between massages.",
  body,
  category: 'lifestyle',
  status: 'published',
  meta_title: "Best Tennis Resorts in Europe 2026: Mouratoglou, Rafa Nadal, La Manga",
  meta_description: "The eight European resorts running tour-grade tennis programs in 2026 — Mandarin Oriental Bodrum (Mouratoglou), Don Carlos Marbella (Rafa Nadal Academy), La Manga, Verdura Sicily, Évian, Pine Cliffs (Annabel Croft), Bürgenstock, Kalimera Kriti.",
  image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/Tennis_centre_la_manga_club.jpg/500px-Tennis_centre_la_manga_club.jpg',
  image_alt: 'Tennis Centre at La Manga Club, Spain — one of Europe\'s largest tennis resorts',
  published_at: now,
  updated_at: now,
...
console.log('   URL:   https://super.tennis/lifestyle/' + slug + '/');
console.log('   Image:', data?.[0]?.image_url);
